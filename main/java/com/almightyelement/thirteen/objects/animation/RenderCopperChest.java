package com.almightyelement.thirteen.objects.animation;
...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/blocks/copper_chest.png");
